import collections
import random as rd
from common.file_operations import Dataset, FileOperations


def generate_signed_networks(c, n: int or list, k, pin, pn, pp) -> Dataset:
    """
...
if __name__ == "__main__":
    ds = generate_signed_networks(c=5, n=100, k=12, pin=0.8, pn=0.1, pp=0)
